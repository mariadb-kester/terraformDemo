...
curl -X POST --header "Content-Type: application/json" -d '{"name":"DO_REPO","value":"'$DO_REPO'"}' https://circleci.com/api/v1.1/project/gh/$CIRCLECI_USER/phpAppDocker/envvar -H "Circle-Token: $CIRCLECI_API"
curl -X POST --header "Content-Type: application/json" -d '{"name":"DO_REPO","value":"'$DO_REPO'"}' https://circleci.com/api/v1.1/project/gh/$CIRCLECI_USER/mariadbServerDocker/envvar -H "Circle-Token: $CIRCLECI_API"
curl -X POST --header "Content-Type: application/json" -d '{"name":"DO_REPO","value":"'$DO_REPO'"}' https://circleci.com/api/v1.1/project/gh/$CIRCLECI_USER/mariadbMaxscaleDocker/envvar -H "Circle-Token: $CIRCLECI_API"
